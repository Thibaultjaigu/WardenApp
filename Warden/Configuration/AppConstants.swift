...
""",
    ...
    static let defaultApiConfigurations: [String: defaultApiConfiguration] = [
        ...
        "requesty": defaultApiConfiguration(name: "Requesty", url: "https://router.requesty.ai/v1/chat/completions", apiKeyRef: "https://app.requesty.ai/api-keys", apiModelRef: "https://docs.requesty.ai", defaultModel: "openai/gpt-4o-mini", models: ["openai/gpt-4o-mini", "openai/gpt-4o", "anthropic/claude-sonnet-4-5", "google/gemini-2.5-flash"], inherits: "chatgpt", imageUploadsSupported: true),
    ...
    static let apiTypes = [
        "chatgpt", "codex", "ollama", "claude", "xai", "gemini", "perplexity", "deepseek", "pollinations", "fireworks", "openrouter", "requesty", "groq",
